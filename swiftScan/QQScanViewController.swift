...
// MARK: - 底部几个功能：开启闪光灯、相册、我的二维码
    ...
    func drawBottomItems()
    {
        ...
        btnFlash.addTarget(self, action: #selector(self.openOrCloseFlash), for: UIControlEvents.touchUpInside)
        ...
        btnMyQR.setImage(UIImage(named: "CodeScan.bundle/qrcode_scan_btn_myqrcode_nor"), for: UIControlState())
